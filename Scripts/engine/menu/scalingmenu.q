...
scalingmenu_bar_scale = PAIR(4.4, 2) 
scalingmenu_bar_focus_rgba = [ 128 128 128 128 ] 
scalingmenu_bar_unfocus_rgba = [ 40 40 40 128 ] 
scalingmenu_bar_pos = PAIR(12, 0) 
scalingmenu_text_pos = PAIR(-102, 0) 
scalingmenu_spacing_between = 25 
scalingmenu_arrow_pos_up = PAIR(0, 7) 
scalingmenu_arrow_pos_down = PAIR(0, -7) 
