...
void CAnimChannel::GetDebugInfo( Script::CStruct* p_info )
{
	...
	p_info->AddFloat( Crc::ConstCRC("m_startTime"), m_startTime );
	p_info->AddFloat( Crc::ConstCRC("m_currentTime"), m_currentTime );
	p_info->AddFloat( Crc::ConstCRC("m_endTime"), m_endTime );
	p_info->AddFloat( Crc::ConstCRC("m_animSpeed"), m_animSpeed );
	p_info->AddInteger( Crc::ConstCRC("m_animComplete"), m_animComplete );
#endif				 
}
