...
bool SetFacePointsStruct(const SFacePoints& face_points, Script::CStruct *p_struct)
{
	...
	p_struct->AddArrayPointer( Crc::ConstCRC("left_eye"), p_left_eye );
	p_struct->AddArrayPointer( Crc::ConstCRC("right_eye"), p_right_eye );
	p_struct->AddArrayPointer( Crc::ConstCRC("nose"), p_nose );
	p_struct->AddArrayPointer( Crc::ConstCRC("lips"), p_lips );

	if (face_points.m_adjust_hsv)
	{
		p_struct->AddFloat(Crc::ConstCRC("h"), face_points.m_h_offset);
		p_struct->AddFloat(Crc::ConstCRC("s"), face_points.m_s_scale);
		p_struct->AddFloat(Crc::ConstCRC("v"), face_points.m_v_scale);
	}

	p_struct->AddInteger( Crc::ConstCRC("width"), face_points.m_texture_width );
	p_struct->AddInteger( Crc::ConstCRC("height"), face_points.m_texture_height );
...
bool GetFacePointsStruct(SFacePoints &face_points, Script::CStruct *p_struct)
{
	...
	// Right eye
	p_struct->GetArray( Crc::ConstCRC("right_eye"), &p_right_eye );
	if (p_right_eye)
	{
	...
	// Nose
	p_struct->GetArray( Crc::ConstCRC("nose"), &p_nose );
	if (p_nose)
	{
	...
	// Lips
	p_struct->GetArray( Crc::ConstCRC("lips"), &p_lips );
	if (p_lips)
	{
	...
	face_points.m_adjust_hsv = p_struct->GetFloat(Crc::ConstCRC("h"), &face_points.m_h_offset);
	face_points.m_adjust_hsv = p_struct->GetFloat(Crc::ConstCRC("s"), &face_points.m_s_scale) && face_points.m_adjust_hsv;
	face_points.m_adjust_hsv = p_struct->GetFloat(Crc::ConstCRC("v"), &face_points.m_v_scale) && face_points.m_adjust_hsv;
	...
	p_struct->GetInteger( Crc::ConstCRC("width"), &face_points.m_texture_width );
	p_struct->GetInteger( Crc::ConstCRC("height"), &face_points.m_texture_height );
