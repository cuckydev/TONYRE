...
void	CEngine::sGetMetrics(Script::CStruct * p_info)
{
	...
	if (sGetMainScene())
	{
		...
		p_info->AddStructurePointer(Crc::ConstCRC("MainScene"),p_main);
	}
	...
	if (sGetSkyScene())
	{
		...
		p_ps2->AddInteger(Crc::ConstCRC("total"), NxPs2::geom_stats_total);        
		p_ps2->AddInteger(Crc::ConstCRC("inactive"), NxPs2::geom_stats_inactive );    
		p_ps2->AddInteger(Crc::ConstCRC("sky"), NxPs2::geom_stats_sky);          
		p_ps2->AddInteger(Crc::ConstCRC("transformed"), NxPs2::geom_stats_transformed);  
		p_ps2->AddInteger(Crc::ConstCRC("skeletal"), NxPs2::geom_stats_skeletal);     
		p_ps2->AddInteger(Crc::ConstCRC("camera_sphere"), NxPs2::geom_stats_camera_sphere);
		p_ps2->AddInteger(Crc::ConstCRC("clipcull"), NxPs2::geom_stats_clipcull);     
		p_ps2->AddInteger(Crc::ConstCRC("culled"), NxPs2::geom_stats_culled);     
		p_ps2->AddInteger(Crc::ConstCRC("leaf_culled"), NxPs2::geom_stats_leaf_culled);     
		p_ps2->AddInteger(Crc::ConstCRC("boxcheck"), NxPs2::geom_stats_boxcheck);     
		p_ps2->AddInteger(Crc::ConstCRC("occludecheck"), NxPs2::geom_stats_occludecheck); 
		p_ps2->AddInteger(Crc::ConstCRC("occluded"), NxPs2::geom_stats_occluded);     
		p_ps2->AddInteger(Crc::ConstCRC("colored"), NxPs2::geom_stats_colored);      
		p_ps2->AddInteger(Crc::ConstCRC("leaf"), NxPs2::geom_stats_leaf);         
		p_ps2->AddInteger(Crc::ConstCRC("wibbleUV"), NxPs2::geom_stats_wibbleUV);     
		p_ps2->AddInteger(Crc::ConstCRC("wibbleVC"), NxPs2::geom_stats_wibbleVC);     
		p_ps2->AddInteger(Crc::ConstCRC("sendcontext"), NxPs2::geom_stats_sendcontext);  
		p_ps2->AddInteger(Crc::ConstCRC("sorted"), NxPs2::geom_stats_sorted);       
		p_ps2->AddInteger(Crc::ConstCRC("shadow"), NxPs2::geom_stats_shadow);       
		
		p_info->AddStructurePointer(Crc::ConstCRC("PS2_Info"),p_ps2);
