...
void CFaceTexture::WriteIntoStructure( Script::CStruct* pSubStruct )
{
	...
	pSubStruct->AddArrayPointer( Crc::ConstCRC("rawTextureData"), pRawTextureArray );
	pSubStruct->AddString( Crc::ConstCRC("overlayTextureName"), m_overlayTextureName );
...
void CFaceTexture::ReadFromStructure( Script::CStruct* pSubStruct )
{
	...
	pSubStruct->GetArray( Crc::ConstCRC("rawTextureData"), &pRawTextureArray, Script::ASSERT );
	...
	pSubStruct->GetString( Crc::ConstCRC("overlayTextureName"), &pOverlayTextureName, Script::ASSERT );
