...
CNgcWeather::CNgcWeather()
{
	...
	m_rain_blend = get_texture_blend( Crc::ConstCRC("fixadd") );		// FixAdd / 64
	m_splash_blend = get_texture_blend( Crc::ConstCRC("fixadd") );		// FixAdd / 64
	m_snow_blend = get_texture_blend( Crc::ConstCRC("fixadd") );		// FixAdd / 64
