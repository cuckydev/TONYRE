...
CPs2Weather::CPs2Weather()
{
	...
	m_rain_blend = NxPs2::CImmediateMode::sGetTextureBlend( Crc::ConstCRC("fixadd"), 64 );		// FixAdd / 64
	m_splash_blend = NxPs2::CImmediateMode::sGetTextureBlend( Crc::ConstCRC("fixadd"), 64 );		// FixAdd / 64
	m_snow_blend = NxPs2::CImmediateMode::sGetTextureBlend( Crc::ConstCRC("fixadd"), 64 );		// FixAdd / 64
