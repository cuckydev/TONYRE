...
static unsigned short s_ascii_to_sjis(unsigned char ascii_code)
{
	...
	{
		case 0xDF: ascii_code='B'; break;
		case 0xC4: ascii_code='A'; break;
		case 0xDC: ascii_code='U'; break;
		case 0xD6: ascii_code='O'; break;
		case 0xE0: ascii_code='a'; break;
		case 0xE2: ascii_code='a'; break;
		case 0xE4: ascii_code='a'; break;
		case 0xEA: ascii_code='e'; break;
		case 0xE8: ascii_code='e'; break;
		case 0xE9: ascii_code='e'; break;
		case 0xEB: ascii_code='e'; break;
		case 0xEC: ascii_code='i'; break;
		case 0xEE: ascii_code='i'; break;
		case 0xEF: ascii_code='i'; break;
		case 0xF4: ascii_code='o'; break;
		case 0xF2: ascii_code='o'; break;
		case 0xF6: ascii_code='o'; break;
		case 0xF9: ascii_code='u'; break;
		case 0xFB: ascii_code='u'; break;
		case 0xFC: ascii_code='u'; break;
		case 0xE7: ascii_code='c'; break;
		case 0x9C: ascii_code='o'; break;
		default: break;
	}
...
static void s_insert_global_info(CStruct *p_struct)
{
	...
	pOptions->AddStructurePointer(Crc::ConstCRC("SplitScreenPreferences"),pTemp);
	...
	pTemp->AddFloat(Crc::ConstCRC("MainVolume"),MainVolume);

	float MusicVolume=Pcm::GetVolume();
	pTemp->AddFloat(Crc::ConstCRC("MusicVolume"),MusicVolume);
	...
	pTemp->AddInteger(Crc::ConstCRC("PlayListForbiddenTrackFlags1"),PlayListForbiddenTrackFlags1);
	pTemp->AddInteger(Crc::ConstCRC("PlayListForbiddenTrackFlags2"),PlayListForbiddenTrackFlags2);
    pTemp->AddInteger(Crc::ConstCRC("PlayListForbiddenTrackFlags3"),PlayListForbiddenTrackFlags3);
	pTemp->AddInteger(Crc::ConstCRC("PlayListForbiddenTrackFlags4"),PlayListForbiddenTrackFlags4);

	// current_soundtrack only applies to XBox
	if (Config::GetHardware()==Config::HARDWARE_XBOX)
	{
		pTemp->AddChecksum(Crc::ConstCRC("current_soundtrack"),Script::GetChecksum("current_soundtrack"));
	}	
	
	if (Pcm::GetRandomMode())
	{
		pTemp->AddChecksum(NONAME,Crc::ConstCRC("RandomMode"));
	}	
	
	pOptions->AddStructurePointer(Crc::ConstCRC("SoundOptions"),pTemp);
	...
	for (int i=0; i<Mdl::Skate::vMAX_SKATERS; ++i)
	{
		...
		{
			pTemp->AddChecksum(NONAME,Crc::ConstCRC("AutoKickOn"));
		}	
		if (pSkate->mp_controller_preferences[i].SpinTapsOn)
		{
			pTemp->AddChecksum(NONAME,Crc::ConstCRC("SpinTapsOn"));
		}	
		if (pSkate->mp_controller_preferences[i].VibrationOn)
		{
			pTemp->AddChecksum(NONAME,Crc::ConstCRC("VibrationOn"));
		}	
		pControllerPrefs->SetStructure(i,pTemp);
	}			
	
	pOptions->AddArrayPointer(Crc::ConstCRC("ControllerPreferences"),pControllerPrefs);
	...
	p_struct->AddStructurePointer(Crc::ConstCRC("Options"),pOptions);
...
static void s_insert_game_save_info(uint32 fileType, CStruct *p_struct)
{
	...
	switch (fileType)
	{
		case 0xb010f357: // OptionsAndPros
		{
			...
			p_struct->AddStructurePointer(Crc::ConstCRC("GlobalInfo"),p_global_info);
			
			Script::CStruct *p_story=new Script::CStruct;
			s_insert_story_info(p_story);
			p_struct->AddStructurePointer(Crc::ConstCRC("Story"),p_story);
			...
			p_struct->AddStructurePointer(Crc::ConstCRC("CustomSkater"),p_custom_skater);
			break;
		}
		...
		case 0x62896edf: // CreatedGoals
		{
			Obj::CCompositeObject *p_obj=(Obj::CCompositeObject*)Obj::CTracker::Instance()->GetObj(Crc::ConstCRC("GoalEditor"));
	...
	if (p_mainData)
	{
		...
		switch (fileType)
		{
			case 0xb010f357: // OptionsAndPros
			{
				...
				int chapter=0;
				p_more_goal_manager_params->GetInteger(Crc::ConstCRC("CurrentChapter"),&chapter);
				...
				p_summaryInfo->AddInteger(Crc::ConstCRC("is_male"),is_male);
                const char *p_name="";
                p_info->GetString(Crc::ConstCRC("display_name"),&p_name);
				p_summaryInfo->AddString(Crc::ConstCRC("name"),p_name);
				break;
			}	
            ...
            case 0x61a1bc57: // Cat
            {
                ...
                const char *p_name="";
				p_data->GetString(Crc::ConstCRC("name"),&p_name,Script::ASSERT);
			...
			case 0x3bf882cc: // Park
			{
				...
				if (p_goals_struct)
				{
					p_goals_struct->GetArray(Crc::ConstCRC("Goals"),&p_goals);
					if (p_goals)
					{
				...
				p_summaryInfo->AddInteger(Crc::ConstCRC("num_gaps"),num_gaps);
				p_summaryInfo->AddInteger(Crc::ConstCRC("num_pieces"),num_metas);
				p_summaryInfo->AddInteger(Crc::ConstCRC("theme"),theme);
				p_summaryInfo->AddChecksum(Crc::ConstCRC("tod_script"),tod_script);
				p_summaryInfo->AddInteger(Crc::ConstCRC("width"),width);
				p_summaryInfo->AddInteger(Crc::ConstCRC("length"),length);
				break;
			}
	...
	else
	{
		...
		switch (fileType)
		{
			...
			case 0x61a1bc57: // Cat
			{
                ...
                const char *p_name="";
				pCreatedTrick->mp_other_params->GetString(Crc::ConstCRC("name"),&p_name,Script::ASSERT);
			...
			case 0x62896edf: // CreatedGoals
			{
				...
				p_summaryInfo->AddInteger(Crc::ConstCRC("num_edited_goals"),p_goal_editor->GetNumGoals());
				
				if (fileType==Crc::ConstCRC("Park"))
				{
					p_summaryInfo->AddInteger(Crc::ConstCRC("MaxPlayers"),Ed::CParkManager::Instance()->GetGenerator()->GetMaxPlayers());
...
static void s_read_global_info(CStruct *p_globalInfo, CScript *p_script)
{
	...
	pOptions->GetStructure(Crc::ConstCRC("SoundOptions"),&pTemp);
	Sfx::CSfxManager * pSfxManager = Sfx::CSfxManager::Instance();
	float MainVolume=0;
	if (pTemp->GetFloat(Crc::ConstCRC("MainVolume"),&MainVolume))
	{
		pSfxManager->SetMainVolume(MainVolume);
	}	

	float MusicVolume=0;
	if (pTemp->GetFloat(Crc::ConstCRC("MusicVolume"),&MusicVolume))
	{
	...
	if (pTemp->GetInteger(Crc::ConstCRC("PlayListForbiddenTrackFlags1"),(int*)&PlayListForbiddenTrackFlags1))
	{
		pTemp->GetInteger(Crc::ConstCRC("PlayListForbiddenTrackFlags2"),(int*)&PlayListForbiddenTrackFlags2);
        pTemp->GetInteger(Crc::ConstCRC("PlayListForbiddenTrackFlags3"),(int*)&PlayListForbiddenTrackFlags3);
        pTemp->GetInteger(Crc::ConstCRC("PlayListForbiddenTrackFlags4"),(int*)&PlayListForbiddenTrackFlags4);
	...
	if (pTemp->ContainsFlag(Crc::ConstCRC("RandomMode")))
	{
	...
	if (Config::GetHardware()==Config::HARDWARE_XBOX)
	{
		...
		pTemp->GetChecksum(Crc::ConstCRC("current_soundtrack"),&current_soundtrack);
        ...
        pTemp2->AddChecksum(Crc::ConstCRC("trackchecksum"),current_soundtrack);
        Script::RunScript(Crc::ConstCRC("set_loaded_soundtrack"), pTemp2);
	}	
	...
	if (pOptions->GetArray(Crc::ConstCRC("ControllerPreferences"),&pControllerPrefs))
	{
		for (int i=0; i<Mdl::Skate::vMAX_SKATERS; ++i)
		{
			...
			pSkate->SetSpinTaps(i,pPrefs->ContainsFlag(Crc::ConstCRC("SpinTapsOn")));
		}	
	}
	...
	if (p_career)
	{
		p_career->GetChecksum(Crc::ConstCRC("LastLevelLoadScript"),&last_level_load_script);
		p_career->GetChecksum(Crc::ConstCRC("LastGameMode"),&last_game_mode);
		// Extract current theme
		p_career->GetInteger(Crc::ConstCRC("current_theme"),&current_theme);
	}
	if (last_level_load_script)
	{
		p_script->GetParams()->AddChecksum(Crc::ConstCRC("LastLevelLoadScript"),last_level_load_script);
	}
	if (last_game_mode)
	{
		p_script->GetParams()->AddChecksum(Crc::ConstCRC("LastGameMode"),last_game_mode);
	}
	//if (current_theme) TT7448: current_theme can be saved as zero
	//{
		Script::CStruct* pTemp2 = new Script::CStruct;
		pTemp2->AddInteger(Crc::ConstCRC("theme_num"),current_theme);
		pTemp2->AddChecksum(Crc::ConstCRC("loading_career"),0);
   ...
   // }
	...
	if (!pSkaterProfile->IsPro())
	{
		...
		p_globalInfo->GetString(Crc::ConstCRC("CASFileName"),&pCASFileName);
...
static int s_get_icon_k_required(uint32 fileType)
{
	...
	{
		case 0xb010f357: // OptionsAndPros
			return Script::GetInteger(Crc::ConstCRC("OptionsProsIconSpaceRequired"));
			break;
		case 0xca41692d: // NetworkSettings
			return Script::GetInteger(Crc::ConstCRC("NetworkSettingsIconSpaceRequired"));
			break;
		case 0xffc529f4: // Cas
			Dbg_MsgAssert(0,("CAS mem card files are no longer supported! Use OptionsAndPros file type instead"));		
			...
			break;
        case 0x61a1bc57: // Cat
			return Script::GetInteger(Crc::ConstCRC("CATIconSpaceRequired"));
			break;
		case 0x3bf882cc: // Park
			return Script::GetInteger(Crc::ConstCRC("ParkIconSpaceRequired"));
			break;
		case 0x26c80b0d: // Replay
			return Script::GetInteger(Crc::ConstCRC("ReplayIconSpaceRequired"));
			break;
		case 0x62896edf: // CreatedGoals
			return Script::GetInteger(Crc::ConstCRC("CreatedGoalsIconSpaceRequired"));
			break;
		default:
										...
										bool *p_insufficientSpace)
{
	...
	switch (fileType)
	{
		case 0xb010f357: // OptionsAndPros
		{
			const char *p_title=Script::GetString(Crc::ConstCRC("cfuncs_str_thugstoryskater"));
		...
		case 0xca41692d: // NetworkSettings
		{
			const char *p_title=Script::GetString(Crc::ConstCRC("cfuncs_str_thugnetsettings"));
			strcpy(pTitle,p_title);
			strcat(pTitle,p_name);
			pIcoName		= "saveimage.xbx";
			// Need new icon ...
		...
		case 0x62896edf: // CreatedGoals
		{
			const char *p_title=Script::GetString(Crc::ConstCRC("cfuncs_str_thuggoals"));
			strcpy(pTitle,p_title);
			strcat(pTitle,p_name);
			pIcoName		= "saveimage.xbx";
			// Need new icon ...
        ...
        case 0x61a1bc57: // CAT
		{
			const char *p_title=Script::GetString(Crc::ConstCRC("cfuncs_str_thugtrick"));
			strcpy(pTitle,p_title);
			strcat(pTitle,p_name);
			pIcoName		= "saveimage.xbx";
		...
		case 0x3bf882cc: // Park
		{
			const char *p_title=Script::GetString(Crc::ConstCRC("cfuncs_str_thugpark"));
			strcpy(pTitle,p_title);
			strcat(pTitle,p_name);
			pIcoName		= "saveimage.xbx";
										...
										bool *p_insufficientSpace)
{
	...
	switch (fileType)
	{
		case 0xb010f357: // OptionsAndPros
		{
			strcpy(pTitle,Script::GetString(Crc::ConstCRC("cfuncs_str_thugstoryskater")));
			...
			#ifdef __NOPT_ASSERT__
			ExpectedIcoSize=Script::GetInt(Crc::ConstCRC("OptionsProsIconSpaceRequired"));
			#endif
			break;
		}
		...
		case 0xca41692d: // NetworkSettings
		{
			strcpy(pTitle,Script::GetString(Crc::ConstCRC("cfuncs_str_thugnetsettings")));
			LineBreak=strlen(pTitle);
			Dbg_MsgAssert(LineBreak<=16,("Mem card title '%s' exceeds 16 chars",pTitle));
			Dbg_MsgAssert(pTitle[LineBreak-1]==':',("Expected mem card file name '%s' to end in ':'",pTitle));
			strcat(pTitle,p_name);
			...
			#ifdef __NOPT_ASSERT__
			ExpectedIcoSize=Script::GetInt(Crc::ConstCRC("NetworkSettingsIconSpaceRequired"));
			#endif
			break;
		}
		...
		case 0xffc529f4: // Cas
		{
			...
			sprintf(pTitle,"THUG Skater:%s",p_name);
			#else
			sprintf(pTitle,Script::GetLocalString(Crc::ConstCRC("cfuncs_str_thps3skater")),p_name);
			#endif
			...
			#ifdef __NOPT_ASSERT__
			ExpectedIcoSize=Script::GetInt(Crc::ConstCRC("CASIconSpaceRequired"));
			#endif
			*/
			break;
		}
        ...
        case 0x61a1bc57: // Cat
		{
			strcpy(pTitle,Script::GetString(Crc::ConstCRC("cfuncs_str_thugtrick")));
			LineBreak=strlen(pTitle);
			Dbg_MsgAssert(LineBreak<=16,("Mem card title '%s' exceeds 16 chars",pTitle));
			Dbg_MsgAssert(pTitle[LineBreak-1]==':',("Expected mem card file name '%s' to end in ':'",pTitle));
			strcat(pTitle,p_name);
			...
			#ifdef __NOPT_ASSERT__
			ExpectedIcoSize=Script::GetInt(Crc::ConstCRC("CATIconSpaceRequired"));
			#endif
			break;
		}
		...
		case 0x62896edf: // CreatedGoals
		{
			strcpy(pTitle,Script::GetString(Crc::ConstCRC("cfuncs_str_thuggoals")));
			LineBreak=strlen(pTitle);
			Dbg_MsgAssert(LineBreak<=16,("Mem card title '%s' exceeds 16 chars",pTitle));
			Dbg_MsgAssert(pTitle[LineBreak-1]==':',("Expected mem card file name '%s' to end in ':'",pTitle));
			strcat(pTitle,p_name);
			...
			#ifdef __NOPT_ASSERT__
			ExpectedIcoSize=Script::GetInt(Crc::ConstCRC("CreatedGoalsIconSpaceRequired"));
			#endif
			break;
		}
		...
		case 0x3bf882cc: // Park
		{
			strcpy(pTitle,Script::GetString(Crc::ConstCRC("cfuncs_str_thugpark")));
			LineBreak=strlen(pTitle);
			Dbg_MsgAssert(LineBreak<=16,("Mem card title '%s' exceeds 16 chars",pTitle));
			Dbg_MsgAssert(pTitle[LineBreak-1]==':',("Expected mem card file name '%s' to end in ':'",pTitle));
			strcat(pTitle,p_name);
			...
			#ifdef __NOPT_ASSERT__
			ExpectedIcoSize=Script::GetInt(Crc::ConstCRC("ParkIconSpaceRequired"));
			#endif
			break;
		}
								...
								const char *p_name)
{
	...
	strcpy((char*)p_buffer, Script::GetString(Crc::ConstCRC("cfuncs_str_ngc_generic_save_name")));
...
static bool s_first_date_is_more_recent(Script::CStruct *p_a, Script::CStruct *p_b)
{
	...
	p_a->GetInteger(Crc::ConstCRC("Hour"),&hour_a);
	p_a->GetInteger(Crc::ConstCRC("Minutes"),&minutes_a);
	p_a->GetInteger(Crc::ConstCRC("Seconds"),&seconds_a);
	...
	p_b->GetInteger(Crc::ConstCRC("Hour"),&hour_b);
	p_b->GetInteger(Crc::ConstCRC("Minutes"),&minutes_b);
	p_b->GetInteger(Crc::ConstCRC("Seconds"),&seconds_b);
...
bool ScriptGetSummaryInfo(Script::CStruct *pParams, Script::CScript *pScript)
{
	...
	pParams->GetInteger(Crc::ConstCRC("VaultData"),&use_vault_data);
...
static uint32 sGetFixedFileSize(uint32 fileType)
{
	...
	{
		case 0xb010f357: // OptionsAndPros
			fixed_size=Script::GetInteger(Crc::ConstCRC("SaveSize_OptionsAndPros"),Script::ASSERT);
			break;
		case 0xffc529f4: // Cas
			Dbg_MsgAssert(0,("CAS mem card files are no longer supported! Use OptionsAndPros file type instead"));
			...
			break;
        case 0x61a1bc57: // Cat
			fixed_size=Script::GetInteger(Crc::ConstCRC("SaveSize_Cat"),Script::ASSERT);
			break;
		case 0x62896edf: // CreatedGoals
			fixed_size=Script::GetInteger(Crc::ConstCRC("SaveSize_CreatedGoals"),Script::ASSERT);
			break;
		case 0x3bf882cc: // Park
			fixed_size=Script::GetInteger(Crc::ConstCRC("SaveSize_Park"),Script::ASSERT);
			break;
		case 0x26c80b0d: // Replay
			fixed_size=Script::GetInteger(Crc::ConstCRC("SaveSize_Replay"),Script::ASSERT);
			break;
		case 0xca41692d: // NetworkSettings
			fixed_size=Script::GetInteger(Crc::ConstCRC("SaveSize_NetworkSettings"),Script::ASSERT);
			break;
		default:
...
bool ScriptSaveToMemoryCard(Script::CStruct *pParams, Script::CScript *pScript)
{
	...
	pParams->GetInteger(Crc::ConstCRC("SaveVaultData"),&save_vault_data);
	if (save_vault_data)
	{
...
bool ScriptSetSectionsToApplyWhenLoading(Script::CStruct *pParams, Script::CScript *pScript)
{
	...
	if (pParams->ContainsFlag(Crc::ConstCRC("ApplyCustomSkater")))
	{
		s_apply_flags |= 1<<APPLY_CUSTOM_SKATER;
	}	
	if (pParams->ContainsFlag(Crc::ConstCRC("ApplyStorySkater")))
	{
		s_apply_flags |= 1<<APPLY_STORY_SKATER;
	}	
	if (pParams->ContainsFlag(Crc::ConstCRC("ApplyStory")))
	{
		s_apply_flags |= 1<<APPLY_STORY;
	}	
	if (pParams->ContainsFlag(Crc::ConstCRC("ApplyGeneralOptions")))
	{
...
bool ScriptLoadFromMemoryCard(Script::CStruct *pParams, Script::CScript *pScript)
{
	...
	pParams->GetInteger(Crc::ConstCRC("LoadForUpload"),&load_for_upload);
...
{
	uint32 file_type=0;
	pParams->GetChecksum(Crc::ConstCRC("type"),&file_type);
