...
//			pCareer->ReadFromStructure(pSkaterInfo);
            ...
            air_value = pProfile->GetStatValue(Crc::ConstCRC("air"));
            run_value = pProfile->GetStatValue(Crc::ConstCRC("run"));
            ollie_value = pProfile->GetStatValue(Crc::ConstCRC("ollie"));
            speed_value = pProfile->GetStatValue(Crc::ConstCRC("speed"));
            spin_value = pProfile->GetStatValue(Crc::ConstCRC("spin"));
            flip_speed_value = pProfile->GetStatValue(Crc::ConstCRC("flip_speed"));
            switch_value = pProfile->GetStatValue(Crc::ConstCRC("switch"));
            rail_balance_value = pProfile->GetStatValue(Crc::ConstCRC("rail_balance"));
            lip_balance_value = pProfile->GetStatValue(Crc::ConstCRC("lip_balance"));
            manual_balance_value = pProfile->GetStatValue(Crc::ConstCRC("manual_balance"));
            ...
            {
                // restore stats
                pProfile->SetPropertyValue(Crc::ConstCRC("air"), air_value);
                pProfile->SetPropertyValue(Crc::ConstCRC("run"), run_value);
                pProfile->SetPropertyValue(Crc::ConstCRC("ollie"), ollie_value);
                pProfile->SetPropertyValue(Crc::ConstCRC("speed"), speed_value);
                pProfile->SetPropertyValue(Crc::ConstCRC("spin"), spin_value);
                pProfile->SetPropertyValue(Crc::ConstCRC("flip_speed"), flip_speed_value);
                pProfile->SetPropertyValue(Crc::ConstCRC("switch"), switch_value);
                pProfile->SetPropertyValue(Crc::ConstCRC("rail_balance"), rail_balance_value);
                pProfile->SetPropertyValue(Crc::ConstCRC("lip_balance"), lip_balance_value);
                pProfile->SetPropertyValue(Crc::ConstCRC("manual_balance"), manual_balance_value);

				// restore trickslot number
				pProfile->SetPropertyValue( Crc::ConstCRC("max_specials"), num_trickslots );
