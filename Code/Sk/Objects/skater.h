...
// #define	USE_BIKE_PHYSICS (Script::GetInteger(Crc::ConstCRC("use_bike_physics")))
// #define	USE_WALK_PHYSICS (Script::GetInteger(Crc::ConstCRC("use_walk_physics")))
// #define	CESS_SLIDE_BUTTONS (control_pad.m_R1.GetPressed() && USE_BIKE_PHYSICS)

#define	SKITCH_BUTTON (control_pad.m_up.GetPressed() && control_pad.m_up.GetPressedTime()>(uint32)GetPhysicsInt(Crc::ConstCRC("Skitch_Hold_Time")))
...
#define		CHEAT_MATRIX		(Mdl::Skate::Instance()->GetCareer()->GetPhysicsInt(Crc::ConstCRC("CheatMatrix"),false)  || GetCheat(GetPhysicsInt(0xf9514c9e)))	  // CHEAT_MATRIX
