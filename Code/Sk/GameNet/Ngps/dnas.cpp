...
static	uint32	s_get_error_desc( int code )
{
	switch( code )
	{
		case sceDNAS2_SS_SERVER_BUSY:
			return Crc::ConstCRC("net_auth_error_server_busy");
			break;
		case sceDNAS2_SS_BEFORE_SERVICE:
			return Crc::ConstCRC("net_auth_error_before_service");
			break;
		case sceDNAS2_SS_OUT_OF_SERVICE:
			return Crc::ConstCRC("net_auth_error_out_of_service");
			break;
		case sceDNAS2_SS_END_OF_SERVICE:
			return Crc::ConstCRC("net_auth_error_end_of_service");
			break;
		case sceDNAS2_SS_SESSION_TIME_OUT:
			return Crc::ConstCRC("net_auth_error_time_out");
			break;
		case sceDNAS2_SS_INVALID_SERVER:
			return Crc::ConstCRC("net_auth_error_invalid_server");
			break;
		case sceDNAS2_SS_INTERNAL_ERROR:
			return CRCD(0x3c0c381,"net_auth_error_internal");
			break;
		case sceDNAS2_SS_EXTERNAL_ERROR:
			return Crc::ConstCRC("net_auth_error_external");
			break;
		case sceDNAS2_SS_ID_NOUSE:
		case sceDNAS2_SS_ID_NOT_JOIN_TO_CAT:
			return Crc::ConstCRC("net_auth_error_unique");
			break;
		...
		case sceDNAS2_SS_DL_NOT_UPDATED:
			return Crc::ConstCRC("net_auth_error_download");
			break;

		case sceDNAS2_SS_INVALID_PS2:
		case sceDNAS2_SS_INVALID_HDD_BINDING:
			return Crc::ConstCRC("net_auth_error_machine");
			break;
		...
		case sceDNAS2_ERR_NET_OTHERS:
			return Crc::ConstCRC("net_auth_error_network");
			break;
		default:
			return Crc::ConstCRC("net_auth_error_generic");
			break;
	}
}
...
static	uint32	s_get_error_footer( int code )
{
	switch( code )
	{
		...
		case sceDNAS2_SS_INVALID_MEDIA:
		case sceDNAS2_SS_INVALID_AUTHDATA:
			return Crc::ConstCRC("net_auth_footer_contact");
		case sceDNAS2_SS_SERVER_BUSY:
		case sceDNAS2_SS_SESSION_TIME_OUT:
		case sceDNAS2_SS_ID_NOUSE:
		case sceDNAS2_SS_ID_NOT_JOIN_TO_CAT:
		...
		case sceDNAS2_SS_DL_OUT_OF_SERVICE:
		case sceDNAS2_SS_DL_NOT_UPDATED:
			return Crc::ConstCRC("net_auth_footer_empty");
		case sceDNAS2_ERR_GLUE_ABORT:
		case sceDNAS2_ERR_NET_PROXY:
		case sceDNAS2_ERR_NET_SSL:
		case sceDNAS2_ERR_NET_DNS_HOST_NOT_FOUND:
		...
		case sceDNAS2_ERR_NET_EINVAL:
		case sceDNAS2_ERR_NET_OTHERS:
			return Crc::ConstCRC("net_auth_footer_network");
		default:
			return Crc::ConstCRC("net_auth_footer_contact");
	}
}
...
static	uint32	s_get_error_footer_pal( int code )
{
	switch( code )
	{
		...
		case sceDNAS2_SS_BEFORE_SERVICE:
		case sceDNAS2_SS_OUT_OF_SERVICE:
			return Crc::ConstCRC("net_auth_footer_service_pal");
		case sceDNAS2_SS_END_OF_SERVICE:
			return Crc::ConstCRC("net_auth_footer_central_pal");
		case sceDNAS2_SS_SESSION_TIME_OUT:
		case sceDNAS2_SS_INVALID_SERVER:
		case sceDNAS2_SS_INTERNAL_ERROR:
		case sceDNAS2_SS_EXTERNAL_ERROR:
			return Crc::ConstCRC("net_auth_footer_cont_customer_pal");
		case sceDNAS2_SS_ID_NOUSE:
		case sceDNAS2_SS_ID_NOT_JOIN_TO_CAT:
		case sceDNAS2_SS_DL_NODATA:
		case sceDNAS2_SS_DL_BEFORE_SERVICE:
		...
		case sceDNAS2_SS_INVALID_MEDIA:
		case sceDNAS2_SS_INVALID_HDD_BINDING:
			return Crc::ConstCRC("net_auth_footer_customer_pal");
		case sceDNAS2_SS_INVALID_AUTHDATA:
			return Crc::ConstCRC("net_auth_footer_clean_pal");
		case sceDNAS2_ERR_GLUE_ABORT:
		case sceDNAS2_ERR_NET_PROXY:
		case sceDNAS2_ERR_NET_SSL:
		case sceDNAS2_ERR_NET_DNS_HOST_NOT_FOUND:
		...
		case sceDNAS2_ERR_NET_EINVAL:
		case sceDNAS2_ERR_NET_OTHERS:
			return Crc::ConstCRC("net_auth_footer_network_pal");
			break;
		default:
			return Crc::ConstCRC("net_auth_footer_central_pal");
			break;
...
bool 		GameNet::Manager::ScriptAuthenticateClient( Script::CStruct* pParams, Script::CScript* pScript )
{
	...
	{
		Script::RunScript( Crc::ConstCRC("connected_to_internet") );
		s_extra_time = 0;
		return true;
	}
#ifdef __DNAS_DEBUG__	
	...
	if( result != 0 )
	{
		...
		if( status.code == 0 )
		{
			pParams->AddInteger( Crc::ConstCRC("code"), 0 );
			pParams->AddInteger( Crc::ConstCRC("sub_code"), 0 );
			desc = Crc::ConstCRC("net_auth_error_generic");
			if( Config::PAL())
			{
				footer = Crc::ConstCRC("net_auth_footer_customer_pal");
			}
			else
			{
				
				footer = Crc::ConstCRC("net_auth_footer_contact");
			}
		}
		else
		{
			Dbg_Printf( " Code: %d  SubCode: %d\n", status.code, status.sub_code );
			pParams->AddInteger( Crc::ConstCRC("code"), status.code );
			pParams->AddInteger( Crc::ConstCRC("sub_code"), status.sub_code );
		...
		pParams->AddString( Crc::ConstCRC("desc"), err_desc );
		pParams->AddString( Crc::ConstCRC("footer"), err_footer );
		Script::RunScript( Crc::ConstCRC("display_auth_error"), pParams );
