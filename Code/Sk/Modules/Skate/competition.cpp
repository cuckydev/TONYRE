...
//	m_leader_board[0].mp_name = "PLAYER 1";
	...
	for (int i = 0;i<vMAX_PLAYERS-1;i++)
	{
		...
		if ( mp_params->GetArray( Crc::ConstCRC("leader_board_names"), &pLeaderBoardNames, Script::NO_ASSERT ) )
		{
	...
	if ( mp_params->GetString( Crc::ConstCRC("first_place_name"), &p_first_place_name, Script::NO_ASSERT ) )
	{
