...
//	pCam->StoreOldPos( );
	...
	if ( !Script::GetInt( Crc::ConstCRC("DisableViewerRoll"), false ) )
	{
...
//		{
//			Script::RunScript(Crc::ConstCRC("UserSelectSelect"));
//		}
	}
	else
	{
		...
		{
			p_script=spawn_if_exists(Crc::ConstCRC("UserSelectSquare"));
		}
		else if ( mdl.m_shift_commands.TestMask( Inp::Data::mD_CIRCLE ))
		{
			// (launches the game)
			p_script=spawn_if_exists(Crc::ConstCRC("UserSelectCircle"));
		}
		else if ( mdl.m_shift_commands.TestMask( Inp::Data::mD_START ))
		{
			p_script=spawn_if_exists(Crc::ConstCRC("UserSelectStart"));
		}
		else if ( mdl.m_shift_commands.TestMask( Inp::Data::mD_X ))
		{
			p_script=spawn_if_exists(Crc::ConstCRC("UserSelectX"));
		}
		else if ( mdl.m_shift_commands.TestMask( Inp::Data::mD_L1 ))
		{
			p_script=spawn_if_exists(Crc::ConstCRC("UserSelectL1"));
		}
		else if ( mdl.m_shift_commands.TestMask( Inp::Data::mD_L2 ))
		{
			p_script=spawn_if_exists(Crc::ConstCRC("UserSelectL2"));
		}
		else if ( mdl.m_shift_commands.TestMask( Inp::Data::mD_R1 ))
		{
			p_script=spawn_if_exists(Crc::ConstCRC("UserSelectR1"));
		}
		else if ( mdl.m_shift_commands.TestMask( Inp::Data::mD_R2 ))
		{
			p_script=spawn_if_exists(Crc::ConstCRC("UserSelectR2"));
		}
		else if ( mdl.m_shift_commands.TestMask( Inp::Data::mD_UP ))
		{
			p_script=spawn_if_exists(Crc::ConstCRC("UserSelectUp"));
		}
		else if ( mdl.m_shift_commands.TestMask( Inp::Data::mD_DOWN ))
		{
			p_script=spawn_if_exists(Crc::ConstCRC("UserSelectDown"));
		}
		else if ( mdl.m_shift_commands.TestMask( Inp::Data::mD_LEFT ))
		{
			p_script=spawn_if_exists(Crc::ConstCRC("UserSelectLeft"));
		}
		else if ( mdl.m_shift_commands.TestMask( Inp::Data::mD_RIGHT ))
		{
			p_script=spawn_if_exists(Crc::ConstCRC("UserSelectRight"));
		}
...
{        
	...
	pStruct->AddString( Crc::ConstCRC("modelName"), p_msg->m_ModelName );
	pStruct->AddChecksum( Crc::ConstCRC("animName"), p_msg->m_AnimScriptName );
	pStruct->AddChecksum( Crc::ConstCRC("skeletonName"), p_msg->m_SkeletonName );
...
CViewer::CViewer( void )
{
	...
	int viewer_controller = Script::GetInt(Crc::ConstCRC("Viewer_controller"), false);
...
{
	if ( !Script::GetInteger( Crc::ConstCRC("ResetCameraToViewerObject"), Script::NO_ASSERT ) )
	{
		return true;
	}
