...
static void s_send_script_name(uint32 script_name, int numReturnAddresses)
{
	...
	{
		Crc::ConstCRC("timeupscript"),
		Crc::ConstCRC("game_update"),
		Crc::ConstCRC("waitonegameframe"),
		Crc::ConstCRC("checkforswitchvehicles"),
		Crc::ConstCRC("just_coasting"),
		Crc::ConstCRC("do_random_effect"),
		Crc::ConstCRC("do_random_effect2"),
		Crc::ConstCRC("do_blur_effect"),
		Crc::ConstCRC("do_blur_effect_accept"),
		Crc::ConstCRC("disable_two_player_option"),
		Crc::ConstCRC("playbrakeanim"),
		Crc::ConstCRC("playbrakeidle"),
		Crc::ConstCRC("handbrake"),
		Crc::ConstCRC("playturnanimorturnidle"),
		Crc::ConstCRC("cessbrake"),
		Crc::ConstCRC("waitanimfinished"),
		Crc::ConstCRC("checkfornetbrake"),
		Crc::ConstCRC("parked_make_set_menu_item"),
		...
		Crc::ConstCRC("vibrateoff"),
		Crc::ConstCRC("switchonboard"),
		...
		Crc::ConstCRC("OnGroundExceptions"),
		Crc::ConstCRC("InAirExceptions"),
		Crc::ConstCRC("ClearExceptions"),
		Crc::ConstCRC("ClearOnExceptionRun"),
...
void CScript::ClearEventHandlerTable()
{
	...
	if (mp_event_handler_table)
	{
		...
		mp_event_handler_table->remove_group(Crc::ConstCRC("all_groups"));
	}
	#endif
}
