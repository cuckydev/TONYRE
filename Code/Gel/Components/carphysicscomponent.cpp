...
void CCarPhysicsComponent::InitFromStructure( Script::CStruct* pParams )
{
	...
	m_minCarRot = Script::GetFloat( Crc::ConstCRC("accelCarRot"), Script::ASSERT );
	pParams->GetFloat( Crc::ConstCRC("accelCarRot"), &m_minCarRot );
	
	m_maxCarRot = Script::GetFloat( Crc::ConstCRC("decelCarRot"), Script::ASSERT );
	pParams->GetFloat( Crc::ConstCRC("decelCarRot"), &m_maxCarRot );
	
	m_stepCarRot = Script::GetFloat( Crc::ConstCRC("speedCarRot"), Script::ASSERT );
	pParams->GetFloat( Crc::ConstCRC("speedCarRot"), &m_stepCarRot );
	
	m_accelToCarRotFactor = Script::GetFloat( Crc::ConstCRC("accelCarRotFactor"), Script::ASSERT );
	pParams->GetFloat( Crc::ConstCRC("accelCarRotFactor"), &m_accelToCarRotFactor );
}
