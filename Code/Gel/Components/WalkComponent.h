...
#define		CRC_WALK Crc::ConstCRC("Walk")
...
{
	Script::CStruct* p_walk_params = Script::GetStructure(Crc::ConstCRC("walk_parameters"));
...
{
	return Mth::Lerp(s_get_param(Crc::ConstCRC("run_speed")), s_get_param(Crc::ConstCRC("combo_run_speed")), m_run_speed_factor);
}
