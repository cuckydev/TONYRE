...
*****************************************************************************/
static constexpr uint32 CRCTable[256] = // CRC polynomial 0xedb88320
{
...
**								Inline Functions							**
*****************************************************************************/
constexpr static inline uint32 ConstCRCCaseSensitive(const char *const literal, size_t max_length = ~(size_t)0, uint32 rc = 0xffffffff)
{
...
constexpr static inline uint32 ConstCRC(const char *const literal, size_t max_length = ~(size_t)0, uint32 rc = 0xffffffff)
{
    if (*literal && max_length)
    {
        char ch = literal[0];
